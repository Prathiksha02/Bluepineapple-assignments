function Complex(real, imaginary) {
  ...
  console.log("Result of addition is: " + add(a,b));
  console.log("Result of subtraction is: " + subtract(a,b));
  console.log("Result of muliplication is: " + multiply(a,b));
  console.log("Result of division is: " + divide(a,b));